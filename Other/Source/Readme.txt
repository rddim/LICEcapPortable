...
user in an INI file next to LICEcapPortable.exe called LICEcapPortable.ini.
...
copy AppNamePortable.ini from this directory to LICEcapPortable.ini next to
LICEcapPortable.exe. The options in the INI file are as follows:
